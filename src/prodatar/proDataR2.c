...
//TIME PRINT
	...
	printf("Request size/process %f MB\n",request_size/1024.0/1024.0);
	printf("Number of Processes %d \n",nprocs);
	printf("Total Request Size %f MB\n",nprocs*request_size/1024.0/1024.0);
	printf("\n\n************Time************\n");
	printf("DataBase Connection Time: %f \n",elapse[0]);       
	printf("DataBase Query Time: %f \n",elapse[1]);    	
        printf("DataBase Query Numbers: %d \n",total_query);
   	printf("I/O MODE(0ind1coll): %d I/O, cost: %f \n",io,elapse[2]);
